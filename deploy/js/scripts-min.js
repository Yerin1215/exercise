(function () {
  ...
  */
  ...
  gsapWithCSS.set("#red-mtn",{transformOrigin:"center"});
  gsapWithCSS.set(".front-mtns",{transformOrigin:"center"});
  gsapWithCSS.set(".trees",{transformOrigin:"center"});
  ...
  let spaceShipTL = gsapWithCSS.timeline();

  gsapWithCSS.set(".flames",{display:"none"});
  gsapWithCSS.set("#window",{transformOrigin: "center"});
  gsapWithCSS.set(".engines",{transformOrigin: "center"});
  gsapWithCSS.set(".bones",{transformOrigin: "center top"});
  gsapWithCSS.set(".left-engines",{rotation:90});
  gsapWithCSS.set(".right-engines",{rotation:-90});
  ...
  gsapWithCSS.set("#space-ship",{transformOrigin:"center"});
  gsapWithCSS.set("#smoke-1",{transformOrigin:"center bottom"});
  gsapWithCSS.set("#smoke-1",{transformOrigin:"center bottom"});
  // gsap.set("#smoke-3",{display:"none"});
  // gsap.set(".smoke",{display:"none"});

  let liftOffTL = gsapWithCSS.timeline();
  ...
  let flamesTL = gsapWithCSS.timeline({paused:true});
  ...
  function controlFlames(){
      gsapWithCSS.set(".flames",{display:"block"});
      flamesTL.play();
  }
  ...
  */
  ...
  let flightTL = gsapWithCSS.timeline();
  ...
  gsapWithCSS.set("#moon",{transformOrigin:"center"});

  // hide moon elements
  gsapWithCSS.set(".moon-things",{opacity:0});

  let moonZoomInTL = gsapWithCSS.timeline();
  ...
  let afterTL = gsapWithCSS.timeline();
  ...
  let mainTL = gsapWithCSS.timeline({paused:true});
